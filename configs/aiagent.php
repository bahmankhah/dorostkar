...
return [
    ...
    'action_types' => [
        'send_email' => [
            'label' => 'ارسال ایمیل',
            'description' => 'ارسال ایمیل به مشتری یا مدیر (از wp_mail استفاده می‌کند)',
            'default_enabled' => true,
            'requires_approval' => false,
        ],
        'send_sms' => [
            'label' => 'ارسال پیامک',
            'description' => 'ارسال پیامک به مشتری (نیاز به پیکربندی ارائه‌دهنده پیامک دارد)',
            'default_enabled' => false,
            'requires_approval' => false,
            'help' => 'برای فعال‌سازی ارسال خودکار پیامک، باید یک فیلتر در افزونه یا قالب خود اضافه کنید. مثال: add_filter("aiagent_send_sms", function($sent, $phone, $message, $provider) { /* کد ارسال پیامک */ return true; }, 10, 4);',
        ],
        'create_discount' => [
            'label' => 'ایجاد تخفیف',
            'description' => 'ایجاد کد تخفیف در ووکامرس',
            'default_enabled' => true,
            'requires_approval' => true,
        ],
        'update_product' => [
            'label' => 'بروزرسانی محصول',
            'description' => 'تغییر قیمت، موجودی یا اطلاعات محصول در ووکامرس',
            'default_enabled' => true,
            'requires_approval' => true,
        ],
        'create_campaign' => [
            'label' => 'ایجاد کمپین',
            'description' => 'ذخیره پیشنهاد کمپین بازاریابی (فقط ذخیره می‌شود، اجرای دستی نیاز است)',
            'default_enabled' => true,
            'requires_approval' => false,
        ],
        'schedule_followup' => [
            'label' => 'زمان‌بندی پیگیری',
            'description' => 'زمان‌بندی ارسال ایمیل یا پیامک پیگیری به مشتری',
            'default_enabled' => true,
            'requires_approval' => false,
        ],
        'create_bundle' => [
            'label' => 'ایجاد بسته',
            'description' => 'ذخیره پیشنهاد بسته محصولات (فقط ذخیره می‌شود، ایجاد دستی نیاز است)',
            'default_enabled' => false,
            'requires_approval' => true,
        ],
        'inventory_alert' => [
            'label' => 'هشدار موجودی',
            'description' => 'تنظیم آستانه هشدار موجودی کم در ووکامرس',
            'default_enabled' => true,
            'requires_approval' => false,
        ],
        'loyalty_reward' => [
            'label' => 'پاداش وفاداری',
            'description' => 'ایجاد کد تخفیف اختصاصی برای مشتریان وفادار',
            'default_enabled' => false,
            'requires_approval' => true,
        ],
        'schedule_price_change' => [
            'label' => 'زمان‌بندی تغییر قیمت',
            'description' => 'زمان‌بندی تغییر قیمت محصول در تاریخ مشخص',
            'default_enabled' => false,
            'requires_approval' => true,
        ],
    ],
    ...
    'settings_schema' => [
        ...
        'schedule_frequency' => [
            ...
            'label' => 'تناوب تحلیل خودکار',
            'section' => 'schedule',
            'description' => 'هر چند وقت یکبار تحلیل خودکار اجرا شود. در حالت دستی فقط با کلیک روی دکمه شروع تحلیل اجرا می‌شود.',
        ],
        ...
        'notify_recipients' => [
            ...
            'default' => [],
            'label' => 'دریافت‌کنندگان اعلان',
            'section' => 'notifications',
            'description' => 'کاربرانی که اعلان‌ها را دریافت می‌کنند. اگر خالی باشد، به مدیر سایت ارسال می‌شود.',
        ],
        'notify_methods' => [
            'type' => 'multiselect',
            'default' => ['email'],
            ...
            'label' => 'روش‌های اعلان',
            'section' => 'notifications',
            'description' => 'روش‌های ارسال اعلان. برای پیامک باید فیلتر aiagent_send_notification_sms را پیاده‌سازی کنید.',
            'help' => 'برای فعال‌سازی ارسال پیامک اعلان، کد زیر را به functions.php اضافه کنید: add_filter("aiagent_send_notification_sms", function($sent, $phone, $message) { /* کد ارسال پیامک */ return true; }, 10, 3);',
        ],
