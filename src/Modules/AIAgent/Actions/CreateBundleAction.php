...
class CreateBundleAction extends AbstractAction
{
    ...
    public function execute(array $data)
    {
        ...
        $bundleName = $this->getField($data, 'bundle_name', __('بسته جدید', 'dorostkar'));
        ...
        return $this->success(__('پیشنهاد بسته ایجاد شد', 'dorostkar'), array_merge($bundleData, ['id' => $bundleId]));
    }
    ...
    public function validate(array $data)
    {
        ...
        if (empty($bundleName)) {
            $errors[] = __('نام بسته الزامی است', 'dorostkar');
        }
