...
class CreateCampaignAction extends AbstractAction
{
    ...
    public function execute(array $data)
    {
        ...
        $campaignName = $this->getField($data, 'campaign_name', __('کمپین جدید', 'dorostkar'));
        ...
        return $this->success(__('کمپین ایجاد شد', 'dorostkar'), array_merge($campaignData, ['id' => $campaignId]));
    }
    ...
    public function validate(array $data)
    {
        ...
        if (empty($campaignName)) {
            $errors[] = __('نام کمپین الزامی است', 'dorostkar');
        }
