...
class LoyaltyRewardAction extends AbstractAction
{
    ...
    public function execute(array $data)
    {
        ...
        if (!$customerId) {
            return $this->error(__('شناسه مشتری یافت نشد', 'dorostkar'));
        }
        ...
        if (!$customer->get_id()) {
            return $this->error(__('مشتری یافت نشد', 'dorostkar'));
        }
        ...
        return $this->success(__('پاداش وفاداری صادر شد', 'dorostkar'), [
            'coupon_id' => $couponId,
            'code' => $rewardCode,
    ...
    public function validate(array $data)
    {
        ...
        if (!$customerId) {
            $errors[] = __('شناسه مشتری الزامی است', 'dorostkar');
        }
