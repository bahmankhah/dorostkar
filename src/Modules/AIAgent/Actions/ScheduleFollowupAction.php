...
class ScheduleFollowupAction extends AbstractAction
{
    ...
    public function execute(array $data)
    {
        ...
        if ($taskId) {
            return $this->success(__('پیگیری زمان‌بندی شد', 'dorostkar'), [
                'task_id' => $taskId,
        ...
        return $this->error(__('خطا در زمان‌بندی پیگیری', 'dorostkar'));
    }
    ...
    public function validate(array $data)
    {
        ...
        if ($followupDays <= 0 && empty($scheduleTime)) {
            $errors[] = __('تعداد روز پیگیری یا زمان زمان‌بندی الزامی است', 'dorostkar');
        }
