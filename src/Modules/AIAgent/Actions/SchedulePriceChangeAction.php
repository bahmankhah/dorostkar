...
class SchedulePriceChangeAction extends AbstractAction
{
    ...
    public function execute(array $data)
    {
        ...
        if (!$newPrice) {
            return $this->error(__('قیمت جدید الزامی است', 'dorostkar'));
        }
        ...
        if ($taskId) {
            ...
            return $this->success(__('تغییر قیمت زمان‌بندی شد', 'dorostkar'), $result);
        }

        return $this->error(__('خطا در زمان‌بندی تغییر قیمت', 'dorostkar'));
    }
    ...
    public function validate(array $data)
    {
        ...
        if (!$newPrice || \floatval($newPrice) <= 0) {
            $errors[] = __('قیمت جدید الزامی است و باید بیشتر از صفر باشد', 'dorostkar');
        }
