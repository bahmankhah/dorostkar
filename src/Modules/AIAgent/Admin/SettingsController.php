 ...
 * 
 * @package Dorostkar\Modules\AIAgent\Admin
 */

namespace Dorostkar\Modules\AIAgent\Admin;
...
class SettingsController
{
    ...
    public function ajaxSaveSettings()
    {
        ...
        if ($result['success']) {
            wp_send_json_success([
                'message' => sprintf(
                    __('%d تنظیم با موفقیت ذخیره شد', 'dorostkar'),
                    $result['updated']
                ),
            ]);
        } else {
    ...
    public function ajaxImportSettings()
    {
        ...
        if (empty($result['errors'])) {
            wp_send_json_success([
                'message' => sprintf(
                    __('%d تنظیم با موفقیت وارد شد', 'dorostkar'),
                    $result['imported']
                ),
            ]);
        } else {
