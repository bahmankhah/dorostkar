 ...
 * 
 * Commands are registered under 'dorostkar ai' namespace
 * 
 * @package Dorostkar\Modules\AIAgent\Commands
 */

namespace Dorostkar\Modules\AIAgent\Commands;
...
class AIAgentCommand
{
     ...
     *
     * ## EXAMPLES
     *     wp dorostkar ai analyze
     *     wp dorostkar ai analyze --type=products
     *
     * @when after_wp_load
     */
     ...
     *
     * ## EXAMPLES
     *     wp dorostkar ai actions list
     *     wp dorostkar ai actions execute --id=123
     *
     * @when after_wp_load
     */
     ...
     *
     * ## EXAMPLES
     *     wp dorostkar ai stats
     *     wp dorostkar ai stats --days=7
     *
     * @when after_wp_load
     */
     ...
     *
     * ## EXAMPLES
     *     wp dorostkar ai settings list
     *     wp dorostkar ai settings get llm_provider
     *     wp dorostkar ai settings set llm_provider openai
     *
     * @when after_wp_load
     */
     ...
     *
     * ## EXAMPLES
     *     wp dorostkar ai resume
     *
     * @when after_wp_load
     */
    public function resume($args, $assoc_args)
    {
        $jobManager = Container::resolve(\Dorostkar\Modules\AIAgent\Services\AnalysisJobManager::class);
