...
class ActionSchedulerJobManager
{
    ...
    public function startJob($type = 'all')
    {
        ...
        if (!$this->isWooCommerceActive()) {
            return [
                'success' => false,
                'error' => __('ووکامرس فعال نیست. این ماژول به ووکامرس نیاز دارد.', 'dorostkar'),
            ];
        }
        ...
        if (!$this->isActionSchedulerAvailable()) {
            return [
                'success' => false,
                'error' => __('Action Scheduler در دسترس نیست. لطفاً ووکامرس را به‌روزرسانی کنید.', 'dorostkar'),
            ];
        }
        ...
        if ($totalItems === 0) {
            return [
                'success' => false,
                'error' => __('هیچ موردی برای تحلیل یافت نشد', 'dorostkar'),
            ];
        }
    ...
    public function cancelJob()
    {
        ...
        return [
            'success' => true,
            'message' => __('تحلیل لغو شد', 'dorostkar'),
        ];
    }
