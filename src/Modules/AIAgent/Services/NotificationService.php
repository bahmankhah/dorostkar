...
class NotificationService
{
    ...
    public function notifyHighPriorityAction(array $action)
    {
        ...
        $subject = sprintf(
            __('[دستیار هوشمند] اقدام با اولویت بالا: %s', 'dorostkar'),
    ...
    public function notifyError($errorMessage, array $context = [])
    {
        ...
        $subject = __('[دستیار هوشمند] خطا در سیستم', 'dorostkar');
    ...
    public function sendDailySummary(array $stats)
    {
        ...
        $subject = sprintf(
            __('[دستیار هوشمند] خلاصه روزانه - %s', 'dorostkar'),
            current_time('Y-m-d')
        );
    ...
    private function buildHighPriorityEmailMessage(array $action)
    {
        ...
        $html .= '<p style="margin-top:20px;"><a href="' . esc_url(admin_url('admin.php?page=dorostkar-ai-agent')) . '" style="display:inline-block;padding:10px 20px;background:#2271b1;color:#fff;text-decoration:none;border-radius:3px;">مشاهده در داشبورد</a></p>';
    ...
    private function buildDailySummaryEmailMessage(array $stats)
    {
        ...
        $html .= '<p><a href="' . esc_url(admin_url('admin.php?page=dorostkar-ai-agent')) . '" style="display:inline-block;padding:10px 20px;background:#2271b1;color:#fff;text-decoration:none;border-radius:3px;">مشاهده داشبورد کامل</a></p>';
