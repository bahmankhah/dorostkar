...
use function Dorostkar\WPLite\appConfig;
    ...
    public function renderField($args)
    {
        ...
        switch ($type) {
            ...
            case 'action_types':
                ...
                echo '<thead><tr>';
                echo '<th style="width: 30%;">' . esc_html__('نوع اقدام', 'dorostkar') . '</th>';
                echo '<th style="width: 35%;">' . esc_html__('توضیحات', 'dorostkar') . '</th>';
                echo '<th style="width: 15%; text-align: center;">' . esc_html__('فعال', 'dorostkar') . '</th>';
                echo '<th style="width: 20%; text-align: center;">' . esc_html__('نیاز به تأیید', 'dorostkar') . '</th>';
                echo '</tr></thead><tbody>';
        ...
        if (isset($config['requires_feature'])) {
            printf(
                ...
                sprintf(
                    esc_html__('Requires %s feature', 'dorostkar'),
