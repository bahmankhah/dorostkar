...
if (!function_exists('Dorostkar\WPLite\appConfig')) {
...
if (!function_exists('Dorostkar\WPLite\appLogger')) {
...
if (!function_exists('Dorostkar\WPLite\load_env_file')) {
...
if (!function_exists('Dorostkar\WPLite\replacePlaceholders')) {
...
if(!function_exists('Dorostkar\WPLite\view')){
    function view($path, $data = []){
        return View::render($path, $data);
    }
}
if(!function_exists('Dorostkar\WPLite\reverse')){
